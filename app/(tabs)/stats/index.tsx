...
const styles = StyleSheet.create({
  ...
  summaryDays: { backgroundColor: '#16213e' },
  summarySessions: { backgroundColor: '#0f3460' },
  summaryNum: { fontSize: 40, fontWeight: '800', color: '#e94560' },
  summaryLabel: { fontSize: 13, color: '#8a8a8a', marginTop: 6, fontWeight: '500' },
  sectionTitle: {
    fontSize: 18,
    fontWeight: '700',
    color: '#e0e0e0',
  ...
  rankTop: { backgroundColor: '#e94560' },
  rankText: { fontSize: 14, fontWeight: '700', color: '#8a8a8a' },
  rankTopText: { color: '#fff' },
  statName: { fontSize: 15, fontWeight: '600', color: '#e0e0e0' },
  statCat: { fontSize: 11, color: '#8a8a8a', marginTop: 1 },
  statRight: { flexDirection: 'row', gap: 18 },
  statItem: { flexDirection: 'row', alignItems: 'baseline', gap: 3 },
  statVal: { fontSize: 18, fontWeight: '700', color: '#e0e0e0' },
  statUnit: { fontSize: 11, color: '#8a8a8a' },
  volumeRow: {
    flexDirection: 'row',
    alignItems: 'center',
    paddingHorizontal: 16,
  ...
  volumeName: { width: 80, fontSize: 13, color: '#e0e0e0', fontWeight: '500' },
  volumeTrack: {
    flex: 1,
    height: 10,
    backgroundColor: '#0f3460',
